# Inherit AOSP device configuration for dart
$(call inherit-product, device/samsung/dart/device_dart.mk)
...
#
PRODUCT_NAME := cyanogen_dart
PRODUCT_BRAND := samsung_dart
PRODUCT_DEVICE := dart
